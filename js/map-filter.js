import {getChekedInputValues} from './utils.js';


const mapFilters = document.querySelector('.map__filters');
const getSimilarAdRank = (similarAd) => {
...
const compareAds = (adA, adB) => {
  const rankA = getSimilarAdRank(adA);
  const rankB = getSimilarAdRank(adB);

  return rankB - rankA;
};

const setAdsFilter = (cb) => {
